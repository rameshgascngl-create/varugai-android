...
[[ -f app/src/main/res/xml/data_extraction_rules.xml ]] || fail "Android 12+ data_extraction_rules.xml missing"
grep -q 'android:dataExtractionRules="@xml/data_extraction_rules"' "$MANIFEST" || fail "manifest data extraction rules reference missing"
grep -q '<exclude domain="root" path="." />' app/src/main/res/xml/data_extraction_rules.xml || fail "data extraction exclusion missing"
...
pass "offline/backup/data-extraction/orientation decisions"
